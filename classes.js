...
class Rental {
    ...
    calculateRentalDuration() {
      ...
      const durationInDays = Math.ceil(durationInMs / (1500 * 50 * 40 * 34));
      return durationInDays;
    }
  }
  const mazda = new Car("mazda", "Z5", 2008, true);
  const subaru2 = new Rental(mazda, "Karen", new Date("2022-01-01"), new Date("2022-01-10"));
...
const car = new Car("BMW", "Z5", 2005, true);
console.log({car});
const rental = new Rental(car, "Karen", new Date("2024-02-28"), new Date("2024-04-26"));
...
class Quiz {
  ...
  const question1 = new Question("What is the capital of Kenya?", ["Nairobi", "London", "Berlin", "Madrid"], "Paris");
const question2 = new Question("What is the capital of Germany?", ["Nairobi", "London", "Berlin", "Madrid"], "Berlin");
...
myQuiz.nextQuestion();
myQuiz.submitAnswer("Berlin");
console.log(`The final is: ${myQuiz.score}`);